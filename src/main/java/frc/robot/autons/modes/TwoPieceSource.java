...
public class TwoPieceSource extends SequentialCommandGroup {
    ...
    public TwoPieceSource(Swerve swerve, Intake intake, OtbIntake otbIntake, Handoff handoff, Shooter shooter){
        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                swerve.runChoreoTraj(Choreo.getTrajectory("sourceCloseForwardSOURCE"), true),
                new IntakeSequence(otbIntake, intake, handoff)
            ),
            new WaitCommand(1),
            swerve.runChoreoTraj(Choreo.getTrajectory("sourceCloseBackwardSOURCE")),
            new ShootSequence(intake, handoff, shooter, commandConstants.rightShootTime, commandConstants.rightShootRatio, commandConstants.handoffIntakeVoltage, commandConstants.handoffShooterVoltage, commandConstants.shootRightVelocity, commandConstants.rightShortTime)
        );
    }
