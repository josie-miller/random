...
public class IntakeSequence extends ParallelDeadlineGroup {
    public IntakeSequence(OtbIntake otbIntake, Intake intake, Handoff handoff) {
        super(
            new InstantCommand(() -> otbIntake.setPivot(Constants.commandConstants.floorDegrees)),
            new RunCommand(() -> otbIntake.requestOTB(Constants.commandConstants.otbVoltage))
        );
